...
% You may need to edit this manually. Just look for the 6-letters code that
% appears after the name of the pipeline in the directory generated by the
% pipeline for a given input file. E.g. if such a directory is called:
%
% pupillator-pd-c04752_gherrero_GLNXa64-R2012b
%
% then you should set PIPE_HASH = 'c04752'
...
aggregate2(files, ['pupillator-pd-' PIPE_HASH '.+features.txt$'], ...
