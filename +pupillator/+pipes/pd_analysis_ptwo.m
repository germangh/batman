function myPipe = pd_analysis_ptwo(varargin)
% PD_ANALYSIS_PTWO - Extraction of pupil diameter features from ptwo files
...
featList = {...
    ...
    @(feats, ev, sel) get_meta(ev{1}, 'Block_1_11'), ...    
...
% Each of these nodes will select one of the 33 blocks. Then it will
